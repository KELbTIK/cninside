...
// find
$find=mysql_query("select * from `blog` where `id`='$id' and `approved`=1") or die('Query Error!');
//////////////verify myself list
...
$page_title =$row['blog_title'].' | '.get_sitename();  //
...
$smarty->display('modules/blog/detail.tpl');
?>
