...
if(!empty($prenum)) {
    ...
    $pre="<a href=\"javascript:;\" onClick=\"window.location='$url'; return true;\">$prename</a>";
}else{
    $pre="<span class=\"disabled\">$prename</span>";
}    
    
if(!empty($nextnum)){
    $url="?page=$nextnum&$querrystring_page"; 
    $next="<a href=\"javascript:;\" onClick=\"window.location='$url'; return true;\">$nextname</a>";
}else{
    $next="<span class=\"disabled\">$nextname</span>";
}
////$head  //last
if($CurPage==1) {
    $head="<span class=\"disabled\">$headname</span>";
}else{
    $url="?page=1&$querrystring_page";
    $head="<a href=\"javascript:;\" onClick=\"window.location='$url'; return true;\">$headname</a>";
}

if($CurPage==$totalpage) {
    $last="<span class=\"disabled\">$lastname</span>";
}else{
    $url="?page=$totalpage&$querrystring_page";
    $last="<a href=\"javascript:;\" onClick=\"window.location='$url'; return true;\">$lastname</a>";
}
...
for($i=$ifrom; $i<=$ito; $i++)
{
    ...
    else
    {
        ...
        $num.="<a href=\"javascript:;\" onClick=\"window.location='$url'; return true;\">$i</a>";
    }
}
