...
<div class="container" >
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title text-center">{l t='Edit business'} {$var_biz.bizname}</h3>
        </div>
        <div id="container">
        ...
        <form action="edit.php?id={$smarty.get.id}" method="post">
            <table class="table table_margin_bottom" width="100%" cellspacing="0" border="0" cellpadding="0">
                <tr>
            ...
            {if $location_required}<tr id="location_city">{else}<tr id="location_city" style="display:none;">{/if}
                ...
                <td>
                    <span id="locationtd">{if $var_biz.c_name} {$var_biz.c_name} / {/if}  {if $var_biz.c_name != $var_biz.province}{$var_biz.province} / {/if}{$var_biz.city} &nbsp; &nbsp;<a href="javascript:void(0);" onclick="$('#locationtd').hide();$('#locationchange').show();">{l t='Change'}</a></span>
            ...
            {/if}
                ...
                <td>
                    <table class="table" width="100%" border="0" cellpadding="0" cellspacing="0"><tr>
            ...
            <tr>
                ...
                <td><img class="img-responsive" src="/images/business/{$var_biz.picurl}_100x100" style="vertical-align:middle" /> &nbsp; &nbsp;<a href="set_cover.php?id={$var_biz.id}" onclick="if(confirm('You are going to Business Images Management Page without saving changes.\n\rSure to continue and abort changes?')==0) return false ;">{l t='Change Cover Image / Manage Images'}</a></td>
            </tr>
            <tr>
