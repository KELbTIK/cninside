<div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="row">
                <br/>
                <p class="text-left col-md-6">{l t='Category'}: {$var_topic.catname}</p>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6 col-xs-12">
                                    <input type="button" class="btn btn-primary col-md-12 col-sm-6 col-xs-12" onclick="javascript:copyToClipboard('link');" value="{l t='Copy'}" >
                                ...
                                <div class="col-md-2 col-sm-4 col-xs-12 pull-right">
                                    ...
                                    {*<a href="/flag.php?topicid={$var_topic.id}&replyid=0&zone=0" class="fancybox fancybox.iframe btn btn-primary pull-right col-xs-12">*}
                                    {*{l t='Flag this'}*}
                                    ...
                                    {foreach from=$var_reply item=i}
                                        <li class="list-group-item">
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-right" >
                                                    <img class="img-responsive" src="../images/photos/{$i.picurl}_40x40" width="40" height="40" />
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
