<div>
			<table cellpadding="0" cellspacing="0" border="0" width="98%" class="listing1">
	  <tr class="header">
...
{foreach from=$var_list item=i}
                    <tr valign="middle">
						<td width="64" style="padding:10px 0px 10px 5px;">
								<div class="clearStyles photoBox" >
			<a href="../my/?id={$i.userid}"><img src="../images/photos/{$i.picurl}_40x40" alt="user photo" border="0" style="height:40px;width:40px;" /></a>	</div></td>
