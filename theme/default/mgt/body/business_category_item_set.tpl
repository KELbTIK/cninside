    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title text-center">
                {l t='Additional Info'} : {$var_bizname}
            </div>
        </div>
        <div class="detail">
            {if $msg}
            ...
            {else}
                <form id="fbusiness" method="post" action="" onsubmit="return formCheck(this)">
                    <table class="table" style="padding:0; margin:0; background:#f0f7fe;border:1px  #BEE3FE solid;" cellspacing="5px" id="features">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                ...
                                <input class="btb btn-primary" type="submit" value="{l t='Submit'}" id="business_feature_submit" /></td>
                        </tr>
                    </table>
                </form>
                {l t='* Required Fields'}
