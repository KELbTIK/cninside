...
<div id="container">
 <!--Main Start-->  
  <div class="detail blue">
        ...
        <h1>Edit business {$var_biz.bizname}</h1>
        {if $msg}
         <p>&nbsp;</p>
         <p>&nbsp;</p>
         <p>&nbsp;</p>
        ...
        <form action="business_edit.php?id={$smarty.get.id}" method="post">
                <table width="100%" cellspacing="0" border="0" cellpadding="0">
                	<tr>
                        ...
                        <td width="70%"><input type="text" name="bizname" value="{$var_biz.bizname}" style="width:95%;"/></td>
                    </tr>
                    ...
                    <tr>
                      <th>{l t='Video URL'}</th>
                      <td><input type="text" name="video" value="{$var_biz.video_url}" style="width:95%;"/></td>
                    </tr>
...
<!--loop-->
                    ...
                    <tr>
                      ...
                      <td><img src="/images/business/{$var_biz.picurl}_100x100" style="vertical-align:middle" /> &nbsp; &nbsp;<a href="business_cover.php?id={$var_biz.id}" onclick="if(confirm('You are going to Business Images Management Page without saving changes.\n\rSure to continue and abort changes?')==0) return false ;">{l t='Change Cover Image / Manage Images'}</a></td>
                    </tr>
                    <tr>
