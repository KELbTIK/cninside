...
function submitform()
{
	...
	$.post("../func/update_array.php?"+Math.random(), {
								   sheet:'business_hole',
								   field:'hole_tip,hole_par,hole_no,hole_picurl',
								   value:hole_tip+','+hole_par+','+hole_no+','+hole_picurl,
								    where:'hole_id',
									equal:hole_id
								   },
			function(data){
 ...
 <div id="main">
    ...
    <div class="content"  style=" position:relative">
      ...
      <div class="left" style=" padding-top:150px;min-height:250px;">
      	<h3>Hole No.</h3>
        <p>
          <input name="hole_no" id="hole_no" type="text" value="{$var_hole.no}" />
        </p>
        <p>&nbsp; </p>
        <h3>Picture Upload</h3>
<input name="hole_picurl" id="hole_picurl" type="text" onFocus="this.blur()" value="{$var_hole.picurl}" style="" /><a href="javascript:win=window.open('../new_photo.php?url=hole_picurl','','resizable=0,scrollbars=0,width=400,height=200');void(0);" style=" border:1px #cbd8ac solid; background:#eef4ea; display:block; padding:2px; width:100px;-moz-border-radius:10px;-moz-box-shadow:0 0 5px #C8C8C8; font-weight:bold; color:#000;text-shadow:1px 1px 0 #FFFFFF; margin-top:10px ; text-align:center;" id="upload_btn">Upload...</a> 
      </div>
      <!-- Right -->
      <div class="right">
      ...
      <textarea id="hole_par" name="hole_par" cols="4" rows="3" style="width:300px;">{$var_hole.par}</textarea>
      </div>
      <div class="con" style="border:none"><h3>Hole Tip</h3>
      <textarea id="hole_tip" name="hole_tip" cols="4" rows="3" style="width:300px;">{$var_hole.tip}</textarea></div>      
      </div>
      </div>
      <div id="clear"></div>
</div>
