...
{if $admin_type}
 <script type="text/javascript" src="/theme/{$get_theme}/mgt/body/js/user.js"></script>
{/if}
 {if $is=='home'}
 {literal}
 <style>
...
function addfriend()
{
 $.post("./func.php?f=addfriend&id="+id+"?"+Math.random(),
  {},function(data){
          if(data.MSG=='1')
        {
            $('.addok').show();
...
<ul>
        <!-- CSS Tabs -->
          <li id="{if $is=='home'}current{/if}"><a href="./?id={$var_get.id}"><span>{l t='Profile Home'} </span></a></li>
          <li id="{if $is=='list'}current{/if}"><a href="./?id={$var_get.id}&f=Lists"><span>{l t='Lists'}</span></a></li>
          <li id="{if $is=='review'}current{/if}"><a href="./?id={$var_get.id}&f=Reviews"><span>{l t='Reviews'}</span></a></li>
          <li id="{if $is=='compliment'}current{/if}"><a href="./?id={$var_get.id}&f=Compliments"><span>{l t='Compliments'}</span></a></li>
          <li id="{if $is=='friend'}current{/if}"><a href="./?id={$var_get.id}&f=Friends"><span>{l t='Friends'}</span></a></li>
          <li id="{if $is=='bookmark'}current{/if}"><a href="./?id={$var_get.id}&f=Bookmarks"><span>{l t='Bookmarks'}</span></a></li>
          <li id="{if $is=='event'}current{/if}"><a href="./?id={$var_get.id}&f=Events"><span>{l t='Event'}</span></a></li>
          <li id="{if $is=='favorite'}current{/if}"><a href="./?id={$var_get.id}&f=Favorites"><span>{l t='Favorites'}</span></a></li>
</ul>
</div>
    ...
    <span class="coner c4"></span>
                  <h1>{l t='Profile'}</h1>
                       ...
                       <div class="t" >
                                  <h3>{if $admin_type}<a class="delcross" href="javascript:del_user2('{$var_user.id}')"><img src="/theme/{$get_theme}/mgt/body/images/b_del.png" alt="{l t='Delete'}" title="{l t='Delete'}" border="0" align="top" /></a><br /> {/if} 
                                  <a href="./?id={$var_user.id}">{$var_user.name}</a></h3>
...
<br />  
           ...
           <h4><img src="../theme/{$get_theme}/images/mail.gif" style="vertical-align:bottom"  /> <a href="./msg.php?f=new&id={$var_user.id}">{l t='Write a Message'}</a></h4>
            {if $var_me.id == ''}
             <h4><img src="../theme/{$get_theme}/images/friend.gif" style="vertical-align:bottom"  /> <a href="/my/login.php">{l t='Add as Friend'}</a> </h4>
            {else}
            {if !$var_user.isfriend}
            {if !$var_user.friendRequestSent}
            <h4 class="add2"><img src="../theme/{$get_theme}/images/friend.gif" style="vertical-align:bottom"  /> <a href="javascript:addfriend()">{l t='Add as Friend'}</a></h4>
                {else}
                <h4><img src="../theme/{$get_theme}/images/friend.gif" style="vertical-align:bottom"  /> {l t='Friend Request Pending'}</h4>
                {/if}
                {/if}
            <h4 class="addok" style="display:none;"><img src="../theme/{$get_theme}/images/friend.gif" style="vertical-align:bottom"  /> {l t='Friend Request Sent.'}</h4>
            {/if}
...
<div class="con" >
              <div>
                <div style="float:left"><h3><a href="./?id={$i.id}" target="_blank">{$i.name}</a> {l t='gave a'} {$i.type} {l t='compliment'}</h3></div>
                            <div style="float:right">
...
<div class="con" >
            ...
            <div id="clear"></div>
            <div>
                        <img height="8" src="../theme/{$get_theme}/images/icons/mail.gif" width="15" /> <a href="../{$smarty.const._BIZ_DIR_}/detail.php?id={$i.id}" target="_blank">{l t='See business detail'}</a>
             </div>
</div>
{/foreach}
<!--/loop--> 
