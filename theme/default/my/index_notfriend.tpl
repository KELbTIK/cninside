        ...
        <div class="row">
            <div class="col-xs-12" id="tabsB">
                <ul class="nav nav-pills nav-profile">
                    <!-- CSS Tabs -->
                    <li class="{if $is=='home'}active{/if}"><a href="./?id={$var_get.id}"><span>{l t='Profile Home'} </span></a></li>
                    <li class="{if $is=='list'}active{/if}"><a href="./?id={$var_get.id}&f=Lists"><span>{l t='Lists'}</span></a></li>
                    <li class="{if $is=='review'}active{/if}"><a href="./?id={$var_get.id}&f=Reviews"><span>{l t='Reviews'}</span></a></li>
                    <li class="{if $is=='compliment'}active{/if}"><a href="./?id={$var_get.id}&f=Compliments"><span>{l t='Compliments'}</span></a></li>
                    <li class="{if $is=='friend'}active{/if}"><a href="./?id={$var_get.id}&f=Friends"><span>{l t='Friends'}</span></a></li>
                    <li class="{if $is=='bookmark'}active{/if}"><a href="./?id={$var_get.id}&f=Bookmarks"><span>{l t='Bookmarks'}</span></a></li>
                    <li class="{if $is=='event'}active{/if}"><a href="./?id={$var_get.id}&f=Events"><span>{l t='Event'}</span></a></li>
                    <li class="{if $is=='favorite'}active{/if}"><a href="./?id={$var_get.id}&f=Favorites"><span>{l t='Favorites'}</span></a></li>
                </ul>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="text-center">
                                ...
                                {else}
                                    {if $var_get.id==''}
                                        <div class="clearfix"></div>
                                        <div><br><a href="./?f=Lists&id={$var_get.id}">{l t='All Lists'}...</a></div>
                                    {/if}
                                {/if}
                            </div>
                        </div>
