            ...
            <div class="col-md-8 col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">{l t='Edit List Description'}</h3>
                        <h4>{l t='Show off your favorites. Choose one of the list ideas on the right, or come up with one of your own.'}</h4>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" action="?f=submit&id={$var.id}" method="post" name="postform" id="postform">
                            <div class="form-group">
                                <label for="list_name" class="col-md-3 control-label">{l t='List Name'}</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="list_name" id="list_name" value="{$var.list_name}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="list_desc" class="col-md-3 control-label">{l t='Description'}</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="list_desc" id="list_desc" rows="7">{$var.list_desc}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-3">
